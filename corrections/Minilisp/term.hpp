...
struct MinilispError {
  enum Type {INVALID_HEADER, EXPECTED_TERM, ARITY_ERROR, UNKNOWN_SYMBOL, TERM_ALLOCATION_FAILED, EVAL_OF_INCOMPLETE} type;
  std::string msg;
};
...
enum BuiltinOp {ADD, SUB, NEG, MUL, DIV, MOD, EQ, NEQ, SUP, SUPEQ, INF, INFEQ, NOT, AND, OR, IF, PRINT};
